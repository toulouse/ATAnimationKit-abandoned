...
static CVReturn ATDisplayLinkCallback(CVDisplayLinkRef displayLink,
...
static CVReturn ATDisplayLinkCallback(CVDisplayLinkRef displayLink,
    ...
    if (self->_paused) {
        ...
        CFTimeInterval timestamp = 1.0 / (inOutputTime->rateScalar * (double)inOutputTime->videoTimeScale / (double)inOutputTime->videoRefreshPeriod);


        self->_timestamp = timestamp;
        dispatch_async_f(self->_displayQueue,
                         (void *)CFBridgingRetain(self),
                         ATDisplayLinkDisplay);
    }
