...
ATValue CGRectBasicPropertyStrategy::interpolate(ATValue fromValue, ATValue toValue, float percent) {
    ATValue result;
    const CGFloat x = fromValue.rectValue.origin.x + (toValue.rectValue.origin.x - fromValue.rectValue.origin.x) * percent;
    const CGFloat y = fromValue.rectValue.origin.y + (toValue.rectValue.origin.y - fromValue.rectValue.origin.y) * percent;
    const CGFloat width = fromValue.rectValue.size.width + (toValue.rectValue.size.width - fromValue.rectValue.size.width) * percent;
    const CGFloat height = fromValue.rectValue.size.height + (toValue.rectValue.size.height - fromValue.rectValue.size.height) * percent;
